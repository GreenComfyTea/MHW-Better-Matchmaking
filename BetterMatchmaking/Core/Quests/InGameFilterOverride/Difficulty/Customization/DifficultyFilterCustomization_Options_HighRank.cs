...
internal class DifficultyFilterCustomization_Options_HighRank : SingletonAccessor
{
    ...
    public bool RenderImGui()
    {
        ...
        if (ImGui.TreeNode(LocalizationManager_I.ImGui.HighRank))
        {
            ...
            changed = ImGui.Checkbox(LocalizationManager_I.ImGui._6, ref _highRank6) || changed;
            changed = ImGui.Checkbox(LocalizationManager_I.ImGui._7, ref _highRank7) || changed;
            changed = ImGui.Checkbox(LocalizationManager_I.ImGui._8, ref _highRank8) || changed;
            changed = ImGui.Checkbox(LocalizationManager_I.ImGui._9, ref _highRank9) || changed;
